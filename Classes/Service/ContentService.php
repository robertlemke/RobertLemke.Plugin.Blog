...
class ContentService
{
     ...
     * @return string
     */
    public function renderContent(Node $node): string
    {
        $content = '';
        ...
        foreach ($childNodes as $contentNode) {
            ...
            if ($contentRepository->getNodeTypeManager()->getNodeType($contentNode->nodeTypeName)?->isOfType('Neos.NodeTypes:TextWithImage')) {
            ...
            } elseif ($contentRepository->getNodeTypeManager()->getNodeType($contentNode->nodeTypeName)?->isOfType('Neos.NodeTypes:Image')) {
                $propertyValue = $contentNode->getProperty('image');
                $attributes = [
                    'width="' . $propertyValue->getWidth() . '"',
                    'height="' . $propertyValue->getHeight() . '"',
